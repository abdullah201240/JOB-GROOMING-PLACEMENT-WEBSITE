...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (in_array($img_ex_lc, $allowed_exs)) {
    ...
    $cvtmp_name = $_FILES['cv']['tmp_name'];
    $cv_ex = pathinfo($cv_name, PATHINFO_EXTENSION);
    $cv_ex_lc = strtolower($cv_ex);

    $allowed_exscv = array("pdf", "docx");

    if (in_array($cv_ex_lc, $allowed_exscv)) {

      $new_cv_name = uniqid("CV-", true) . '.' . $cv_ex_lc;
      $cv_upload_path = 'uploads/' . $new_cv_name;
      move_uploaded_file($cvtmp_name, $cv_upload_path);


      $sql1 = "INSERT INTO `apply`( `name`, `address`, `email`, `uid`, `image`, `cv`,jobid) VALUES ('$name','$address','$email','$uid','$img_upload_path','$cv_upload_path','$id')";
...
<head>
  ...
  <script
    src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&key=AIzaSyA_1WnWHIkFTsO2Idzkc48hSgYqNK246vo"></script>
  ...
  <div class="float-container">
    <div id="survey-container">
      ...
      <form id="survey-form" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="input-container">
          ...
          <input class="row-input" type="text" name="name" placeholder="Full Name" required>
        </div>

        <label class="row-label">
          <i class="fas fa-address-card"></i> Address Line:
        </label>
        <div class="input-container">
          <i class="fas fa-address-card input-icon"></i>
          <input class="row-input" type="text" id="to" name="address" placeholder="Address Line" required>
        </div>
        ...
        <div class="input-container">
          ...
          <input class="row-input" type="text" name="email" placeholder="Email" required>
        </div>
    ...
    <div id="survey-container_2">
      ...
      <div class="input-container">
        ...
        <input class="row-input" type="file" name="image" placeholder="Image" required>
      </div>
      ...
      <div class="input-container">
        ...
        <input class="row-input" type="file" name="cv" placeholder="CV" required>
      </div>
