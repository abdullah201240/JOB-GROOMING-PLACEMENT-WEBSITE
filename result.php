...
<div class="container">
<h1  class=h1; style="color:#4CAF50; font-size: xxx-large;">Congratulations   <i class="far fa-grin-beam" style="color: #4CAF50;"></i></h1>
<p style="color:#4CAF50; font-size: xx-large;">You got <?php
$s=$s-1;
$mark=$k/$s;

$mark=$mark*100;
echo$mark?>% marks</p>
<p style="color:black ; font-size: xx-large;">You are selected!&nbsp Apply for this job.</p>

 <?php echo"<a href='form2.php?id=$id'><button class='btn'>Apply Now</button></a>" ?>
</div>
